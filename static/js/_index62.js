...
function display_ayas_data(aya_no) {
    ...
    $.map(ayas_data, function (aya, i) {
        ...
        if (stat.display.mode.a) {
            out += '<div class="aya-A"><span class="link' + active + '" rel="aya-' + ne + '" lang="ar" onclick="sa(' + ne + ');" ondblclick="pa(this);">' + aya.a + '</span> <span class="aya_num">﴿<strong>' + na + '</strong>﴾</span></div>';
            if (sep_a) out += '<div class="sep-thin"></div>';
            active = '';
        }
        if (stat.display.mode.t) {
            out += '<div class="aya-T"><span class="link' + active + '" rel="aya-' + ne + '" lang="ar" onclick="sa(' + ne + ');" ondblclick="pa(this);">' + parse_tajweed(aya.t) + '</span> <span class="aya_num">﴿<strong>' + na + '</strong>﴾</span></div>';
        ...
        if (stat.display.mode.w) {
            ...
            for (j = 0; j < lines_num; j++) {
                ...
                if (last_row_of_words) out += '<td valign="middle" class="n"><span class="aya_num">﴿<strong>' + na + '</strong>﴾</span></td>';
                out += '</tr></table>';
            }
