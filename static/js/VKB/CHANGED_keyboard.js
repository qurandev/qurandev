...
(function() {
  ...
  this.VKI_isMoz = (!this.VKI_isWebKit && navigator.product == "Gecko");
	...
	this.VKI_showVersion = false;	this.VKI_imageURI = '/static/js/VKB/keyboard.png';
	//this.VKI_clickless = 1000; //delay of 1 sec, on mouseover
	//this.VKI_size = 3; //9px, 11px (default), 13px, 16px and 20px; corresponding to the sizes 1 to 5 respectively. 
